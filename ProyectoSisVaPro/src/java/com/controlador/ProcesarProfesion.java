...
import com.modelo.CrudProfesion;
...
/**
 * Nombre del Servlet:ProcesarProfesion
 * Versión:1.0
 * Fecha:07/10/2017
 * Copyright:Sisvapro
...
public class ProcesarProfesion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            pro.setIdProfesion(Integer.parseInt(request.getParameter("txtIdProfesion")));
            pro.setNombreProfesion(request.getParameter("txtNombre"));
         if (request.getParameter("btnInsertar")!=null) {
            crud.insertarProfesion(pro);
            val="Datos insertados Correctamente";
        }else if (request.getParameter("btnModificar")!=null) {
            crud.modificarProfesion(pro);
