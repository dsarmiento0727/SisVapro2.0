...
public class ProcesarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            usu.setIdTipoUsuario(Integer.parseInt(request.getParameter("lstTipoUsuario")));
            if (request.getParameter("btnInsertar")!=null) {
                crud.insertarUsuario(usu);
                val="Datos insertados Correctamente";
            }else if (request.getParameter("btnModificar")!=null) {
                crud.modificarUsuario(usu);
            }else if (request.getParameter("btnEliminar")!=null) {
                crud.eliminarUsuario(usu);
            }
            
            request.setAttribute("valor", val);
            request.getRequestDispatcher("gestionarUsuario.jsp").forward(request, response);
        } catch (Exception e) {
